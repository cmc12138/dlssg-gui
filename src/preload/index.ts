...
const api: DshApi = {
  ...
  scanCleanup: () => ipcRenderer.invoke(IPC.cleanupScan),
  runCleanup: (paths: string[]) => ipcRenderer.invoke(IPC.cleanupRun, paths),
  ...
  refStatus: (id: string) => ipcRenderer.invoke(IPC.refStatus, id),
  refLatest: (id: string) => ipcRenderer.invoke(IPC.refLatest, id),
  refInstall: (id: string, zipPath?: string) => ipcRenderer.invoke(IPC.refInstall, id, zipPath),
  refRemove: (id: string) => ipcRenderer.invoke(IPC.refRemove, id),
